...
path  = '/media/gidi/SSD/Thesis/Data/Checkpoints/Results/batch1/'
...
#    file_name = path+'exp'+str(ii+1)+'/iou_values_test.npy'
#    iou_test.append(np.load(file_name))
#
#    file_name = path+'exp'+str(ii+1)+'/accuracy_values_test.npy'
#    acc_test.append(np.load(file_name))
#    
#    file_name = path+'exp'+str(ii+1)+'/accuracy_values.npy'
#    acc_train.append(np.load(file_name))
#    
#    file_name = path+'exp'+str(ii+1)+'/iou_values.npy'
